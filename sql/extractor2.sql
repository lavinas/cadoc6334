...
CREATE TABLE extractor_process_main (
    -- ID
    id BIGSERIAL PRIMARY KEY, 
...
-- Main Extractor Process Control
CREATE TABLE extractor_main_control (
    -- id
    id BIGSERIAL PRIMARY KEY,
    ...
    -- status
    status_id INT NOT NULL, -- 1 - new, 2 - processing, 3 - completed, 4 - error, 5 - inserting_partial_error, 6 - inserting_final_error
...
CREATE TABLE extractor_reprocessing_control (
    ...
    last_error_message VARCHAR(300),
    -- status
    status_id INT NOT NULL, -- 1 -new, 2 - processing, 3 - completed, 4 - error,  6 - inserting_error
    status_name VARCHAR(20) NOT NULL,
    -- structure
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE extractor_execution (
    ...
    execution_type VARCHAR(20) NOT NULL,  -- 'MAIN' ou 'REPROCESS'
    -- parameters
    ...
    -- status
    status_id INT NOT NULL, -- 1 -new, 2 - processing, 3 - completed, 4 - error, 5 - inserted, 6 - inserting_error
    status_name VARCHAR(20) NOT NULL,
